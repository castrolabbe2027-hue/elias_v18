/**
 * Script para generar archivo CSV de calificaciones 2024
 * 
 * Especificaciones:
...
const SEMESTER_1 = {
  start: new Date(2024, 2, 1),  // Marzo 1
  end: new Date(2024, 5, 30)    // Junio 30
};

const SEMESTER_2 = {
  start: new Date(2024, 6, 1),   // Julio 1
  end: new Date(2024, 11, 20)    // Diciembre 20
};
...
async function generateGrades() {
  console.log('📚 Generando calificaciones 2024...\n');
  ...
  // Guardar archivo
  const outputPath = path.join(__dirname, '../public/test-data/calificaciones-completo-2024.csv');
